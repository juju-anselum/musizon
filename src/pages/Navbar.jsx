...
const Navbar = () => {
    return (
        <>
            <div className="w-full h-full hidden p-5 pl-0 lg:flex flex-col items-center justify-start gap-6">
                <div className="w-full h-max bg-[#121212] px-4 py-5 rounded-md">
                    <div className="w-full h-max flex items-center justify-start gap-4">
                ...
                <div className="w-full h-max flex flex-col gap-6 bg-[#121212] p-3 rounded-md">
                    ...
                    <div className="w-full h-max px-4 py-4 flex items-center justify-start gap-5 rounded-md transition-all duration-200 hover:bg-primaryColorAccent">
                        ...
                        <p className="text-lg font-normal tracking-wide">Recommended</p>
                    </div>
                </div>
            </div>

            <div className="w-full h-max lg:hidden px-5 py-6 pb-8 flex items-center justify-between bg-[#121212]">
